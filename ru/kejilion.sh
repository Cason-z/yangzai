...
UserLicenseAgreement() {
	clear
	echo -e "${gl_kjlan}Добро пожаловать в The 洋仔 Script Toolbox${gl_bai}"
	echo "Впервые используя сценарий, пожалуйста, прочитайте и согласитесь с пользовательским лицензионным соглашением."
	echo "Пользовательский лицензионный соглашение: 洋仔"
	echo -e "----------------------"
...
EOF
		  ...
		  41)
			...
			echo "Доска объявлений 洋仔 была перенесена в официальное сообщество! Пожалуйста, оставьте сообщение в официальном сообществе!"
			echo "洋仔"
			  ;;
		  ...
		  102)
			  ...
			  echo "------------------------------------------------"
			  echo "Полностью удалит сценарий 洋仔 и не повлияет на ваши другие функции"
			  read -e -p "Вы обязательно продолжите? (Y/N):" choice
...
while true; do
	  ...
	  echo -e "${gl_kjlan}11. ${gl_bai}Установите сценарий 洋仔${gl_kjlan}12. ${gl_bai}Обновите систему${gl_kjlan}13. ${gl_bai}Очистить систему"
...
echo -e "${gl_bai}Веб -сайт: 洋仔${gl_bai}"
echo "------------------------"
echo ""
...
echo "------------------------"
echo -e "${gl_kjlan}B Станция:${gl_bai}https://b23.tv/2mqnQyh              ${gl_kjlan}Масляная труба:${gl_bai}洋仔${gl_bai}"
echo -e "${gl_kjlan}Официальный веб -сайт:${gl_bai}洋仔               ${gl_kjlan}Навигация:${gl_bai}洋仔${gl_bai}"
echo -e "${gl_kjlan}Блог:${gl_bai}洋仔          ${gl_kjlan}Центр программного обеспечения:${gl_bai}洋仔${gl_bai}"
echo "------------------------"
echo ""
}
...
echo "╠╩╗║╣  ║║║  ║║ ║║║║ ╚═╗╠═╣"
echo "╩ ╩╚═╝╚╝╩╩═╝╩╚═╝╝╚╝o╚═╝╩ ╩"
echo -e "洋仔 Script Toolbox V$sh_v"
