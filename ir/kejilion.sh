...
EOF
		  ...
		  21)
			  ...
			  while true; do
				  ...
				  case $host_dns in
					  1)
						  read -e -p "لطفاً یک فرمت جدید تجزیه و تحلیل را وارد کنید: 110.25.5.5.33 洋仔.pro:" addhost
...
echo -e "${gl_bai}وب سایت: 洋仔${gl_bai}"
echo "------------------------"
echo ""
...
echo "------------------------"
echo -e "${gl_kjlan}ایستگاه ب:${gl_bai}https://b23.tv/2mqnQyh              ${gl_kjlan}لوله روغن:${gl_bai}洋仔${gl_bai}"
echo -e "${gl_kjlan}وب سایت رسمی:${gl_bai}洋仔               ${gl_kjlan}ناوبری:${gl_bai}洋仔${gl_bai}"
echo -e "${gl_kjlan}وبلاگ:${gl_bai}洋仔          ${gl_kjlan}مرکز نرم افزار:${gl_bai}洋仔${gl_bai}"
echo "------------------------"
echo ""
}
